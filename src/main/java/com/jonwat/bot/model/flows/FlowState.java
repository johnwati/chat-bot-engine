...
public class FlowState implements Serializable
{
    ...
    private final static long serialVersionUID = 1758335937945917111L;
     ...
     * @param key
     */
    public FlowState(String key, String value) {
        super();
        this.key = key;
        this.value = value;
    }
    ...
    public String toString() {
        ...
        sb.append(FlowState.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FlowState) == false) {
            return false;
        }
        FlowState rhs = ((FlowState) other);
