...
public class NextNode implements Serializable
{
    ...
    private final static long serialVersionUID = -7494568095521447380L;
     ...
     * @param connections
     */
    public NextNode(List<Connection> connections) {
        super();
    ...
    public String toString() {
        ...
        sb.append(NextNode.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NextNode) == false) {
            return false;
        }
        NextNode rhs = ((NextNode) other);
