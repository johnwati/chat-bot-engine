...
public class NodeUserInput implements Serializable
{
    ...
    private final static long serialVersionUID = 2970889770981196254L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public NodeUserInput() {
    }
     ...
     * @param key
     */
    public NodeUserInput(String key, String value) {
        super();
        this.key = key;
        this.value = value;
    }
    ...
    public String toString() {
        ...
        sb.append(NodeUserInput.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NodeUserInput) == false) {
            return false;
        }
        NodeUserInput rhs = ((NodeUserInput) other);
